  ...
  \framebox[\textwidth][c]{
    \parbox{\textwidth}{
      ...
      \begin{prooftree}
        \hypo{\text{l is a label}}
        \hypo{\text{o} \in \mathbb{Z}}
        \infer2{(H \mid \chi \mid \sigma \mid \text{st s, o(l)}; C) \vDash (H, H_D[H_D[\text{l}]^8 + \text{o}]^8 \gets \chi[s] \mid \chi \mid \sigma \mid C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \hypo{\text{l is a label}}
        \hypo{\text{o is a register}}
        \infer2{(H \mid \chi \mid \sigma \mid \text{st s, o(l)}; C) \vDash (H, H_D[H_D[\text{l}]^8 + \chi[\text{o}]]^8 \gets \chi[s] \mid \chi \mid \sigma \mid C)}
      \end{prooftree}
    }
  }
