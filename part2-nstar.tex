  ...
  \framebox[\textwidth][c]{
    \parbox{\textwidth}{
      ...
      \begin{prooftree}
        ...
        \infer1[reduc(jmp)]{(H \mid \chi \mid \sigma \mid \text{jmp r}; C) \vDash (H \mid \chi \mid \sigma \mid H_C[\chi[\text{r}]]; C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \hypo{\text{l is a label}}
        \infer1[reduc(jmp)]{(H \mid \chi \mid \sigma \mid \text{jmp l}; C) \vDash (H \mid \chi \mid \sigma \mid H_C[l]; C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \infer0[reduc(halt)]{(H \mid \chi \mid \sigma \mid \text{halt}; C) \vDash (H \mid \chi \mid \sigma \mid \cdot)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \infer0[reduc(salloc)]{(H \mid \chi \mid \sigma \mid \text{salloc n}; C) \vDash (H \mid \chi \mid \cdot^\text{n}\dblcolon\sigma \mid C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \infer0[reduc(sfree)]{(H \mid \chi \mid \cdot^\text{n}\dblcolon\sigma \mid \text{sfree n}; C) \vDash (H \mid \chi \mid \sigma \mid C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \infer0[reduc(sld)]{(H \mid \chi \mid \sigma \mid \text{sld n, s, r}; C) \vDash (H \mid \chi, \chi[\text{r}] \gets (\sigma - \text{n})^\text{s} \mid \sigma \mid C)}
      \end{prooftree}
    }
  }
