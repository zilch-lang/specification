...
\begin{longtable}[H]{p{0.25\textwidth}p{0.65\textwidth}}
	...
	\csname Inlog2\endcsname{O}{a}{b}{r}   & Stores the result of the logical binary computation \texttt{O(a, b)} into the register \texttt{r}                           \\
	\Innot{a}{r}                           & Performs one's complement negation on \texttt{a} and stores the result in the register \texttt{r}                           \\
	\csname Inarith2\endcsname{O}{a}{b}{r} & Stores the result of the arithmetic binary computation \texttt{O(a, b)} into the register \texttt{r}                        \\
	\bottomrule
