...
\begin{figure}[H]
  ...
  \framebox[\textwidth][c]{
    \parbox{\textwidth}{
      ...
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \infer0{(H \mid \chi \mid \sigma \mid \text{sld n, s, r}; C) \vDash (H \mid \chi, \chi[\text{r}] \gets (\sigma - \text{n})^\text{s} \mid \sigma \mid C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
        \infer0{(H \mid \chi \mid \sigma \mid \text{sst r, n}; C) \vDash (H \mid \chi \mid (\sigma - \text{n})^8 \gets \chi[\text{r}] \mid C)}
      \end{prooftree}
      \\\vspace{\baselineskip}
      \begin{prooftree}
