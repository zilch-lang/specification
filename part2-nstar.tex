...
\begin{xltabular}{\textwidth}{*{4}{>{\scriptsize}c}>{\tiny\bfseries}Y*{4}{>{\scriptsize}c}}
	...
	$H$ & $\chi$ & $\sigma$ & \Incjmp{cc}{x}{y}{lt}{lf}$; C$ & $\bm{\mapsto}$ & $H$ & $\chi$ & $\sigma$ & $\Enderef{\Enindex{\HC}{l}}; C$ \\
	\multicolumn{9}{>{\scriptsize}r}{$l=\begin{cases}lt & \text{iff\ } cc(x, y) = \top\\lf & \text{otherwise}\end{cases}$} \\
