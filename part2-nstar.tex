...
\begin{figure}[htb]
  ...
  \begin{prooftree}
    \Hypo{\Delta\vdash^T_{code}$ e : t$}
    \Hypo{$r is a register$}
    \Infer2[\texttt{mov} to register]{\Delta\vdash^I$ mov e, r $\dashv\Delta\setminus$ r, r : t $}
  \end{prooftree}
  \\\vspace{\baselineskip}
  \begin{prooftree}
    ...
    \Infer4[\texttt{mov} to raw pointer offset]{\Delta\vdash^I$ mov e, m(d) $\dashv\Delta}
  \end{prooftree}
