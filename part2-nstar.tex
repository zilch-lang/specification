...
\begin{itemize}
  ...
  \item Type inference
        \begin{itemize}
          ...
          \item $\Delta\vdash^{I}instr\dashv\Delta'$ denotes that the inference of the instruction $instr$ in the current typing context $\Delta$ yields a new typing context $\Delta'$;
        \end{itemize}
\end{itemize}
