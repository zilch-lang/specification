...
\begin{figure}[H]
  ...
  \framebox[\textwidth][c]{\parbox{\textwidth}{
      ...
      \begin{prooftree}
        ...
        \infer[no rule, rule margin=1.0ex]2{\Xi;\Gamma;\hat{\chi};\hat{\sigma};$ r $\vdash^T_{code}$ r : $\forall$().\{ $\chi^\prime\oplus\rho$ | $\sigma^\prime\to\epsilon^\prime$ \}\hspace{1.5em}$%
      ...
      \begin{prooftree}
        ...
        \infer[no rule, rule margin=1.0ex]3{$t$_n\sim\forall$().\{ $\chi^\prime\oplus\rho$ | $\sigma^\prime\to\epsilon^\prime$ \}\hspace{1.5em}$%
                                            \chi\sim\hat{\chi}$\hspace{1.5em}$%
                                            \sigma=$ t$_0$::t$_1$::\ldots::t$_p$::s\hspace{1.5em}$%
                                            \bigwedge_{\text{r}\in\text{bang}(\hat{\chi})} $r $\not\in\rho}
        \infer1[function call]{\Xi;\Gamma;\chi;\sigma;\epsilon\vdash^I$ call l<$\vec{v}$> $\dashv\chi;\sigma;\epsilon}
      \end{prooftree}
  }}
