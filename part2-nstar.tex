...
\begin{figure}[H]
  ...
  \framebox[\textwidth][c]{\parbox{\textwidth}{
      ...
      \begin{prooftree}
        ...
        \hypo{$t$_n\neq$ !$}
        \infer5[store value in stack]{\Xi;\Gamma;\chi;\hat{\sigma};\epsilon\vdash^I$ sst e, n $\dashv\chi;\hat{\sigma};\epsilon}
      \end{prooftree}
  }}
...
\begin{figure}[H]
  ...
  \framebox[\textwidth][c]{\parbox{\textwidth}{
      ...
      \begin{prooftree}
        ...
        \infer[no rule, rule margin=1ex]2{\Xi;\Gamma;\chi;\sigma;\epsilon\vdash^T_{code}$ l<$\vec{v}$> : $\forall$().\{ $\hat{\chi},$ r : $\forall().\{$ $\hat{\chi}^\prime$ | $\sigma^\prime\to\epsilon^\prime$ $\}$ | $\sigma\to$ r \}$}
      ...
      \begin{prooftree}
        \hypo{$n $\in\mathbb{N}}
        \hypo{$n $\leq$ p$}
        \hypo{\Xi;\Gamma;\chi;\sigma;\epsilon\vdash^T_{code}$ l<$\vec{v}$> : $\forall$().\{ $\hat{\chi}$ | $\hat{\sigma}\to$ n \}$}
