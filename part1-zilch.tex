	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\begin{prooftree}
				...
				\hypo{\pi = 0 \Leftrightarrow \epsilon \equiv \Etotal \wedge \epsilon^\prime \equiv \Etotal}
				\infer3[\textsc{[$\rightarrow$-I]}]{\TypeSequent{\Gamma}{\Elam{x}{\rho}{A}{e}}{\pi}{\Epi{x}{\rho}{A}{\epsilon}{B}}{\epsilon^\prime}}
			\end{prooftree}
		}
	}
