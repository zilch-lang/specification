...
\begin{figure}[H]
	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\scalebox{.5}{
				\includegraphics[width=\linewidth]{zilch/expression/pair-mult-intro}
			}\\
			\scalebox{.8}{
				\includegraphics[width=\linewidth]{zilch/expression/pair-mult-elim}
			}
		}
	}
...
\begin{figure}[H]
	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\scalebox{.5}{
				\includegraphics[width=\linewidth]{zilch/expression/pair-add-intro}
			}\\
			\scalebox{.6}{
				\includegraphics[width=\linewidth]{zilch/expression/pair-add-elim}
			}
		}
	}
...
One must be careful about importing non-module elements.
