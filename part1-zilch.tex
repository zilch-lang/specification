	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\begin{prooftree}
				...
				\infer[no rule, rule margin=1ex]2{\TypeSequent{\Gamma_0}{x}{1}{A}{\mathsf{eff}, \epsilon}\hspace{1.5em}%
				\TypeSequent{\scale{0}{\Gamma_i}}{op_i}{0}{\Efun{\overrightarrow{\rho_i\ A_i}}{\Eeffectrow{\mathsf{eff}}{}}{B_i}}{\Etotal}}
				\infer[no rule, rule margin=1ex]1{\TypeSequent{\Gamma_i, \Eresume :^{\varsigma_i} \Efun{B_i}{\epsilon_j}{A}, x_k :^{\rho_k} A_k }{e_i}{\pi}{A}{\epsilon_j}\hspace{1.5em}%
				\pi \neq 0}
				\infer1[\textsc{[Effect-E]}]{\TypeSequent{\scale{\pi}{\Gamma_0}, \Gamma_i}{\Ewithhnd{\mathsf{eff}}{\varsigma_i}{op_i}{(\overrightarrow{x_k})}{e_i}{x}}{\pi}{A}{\epsilon,\epsilon_j}}
			\end{prooftree}
		}
	}
