	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\begin{prooftree}
				...
				\hypo{\pi=0 \Rightarrow \epsilon,\epsilon^\prime \equiv \Etotal}
				\infer4[\textsc{[bool-E$_0$]}]{\TypeSequent{\Gamma}{\Eifthenelse{c}{t}{e}}{\pi}{\Eifthenelse{c}{t}{e}}{\epsilon,\epsilon^\prime}}
			\end{prooftree}
			\\\vspace*{\baselineskip}
			\begin{prooftree}
				\hypo{\TypeSequent{\Gamma_1}{c}{\rho}{\Ebool}{\Etotal}}
				\hypo{\TypeSequent{\Gamma_2}{t}{1}{A}{\epsilon}}
				\hypo{\TypeSequent{\Gamma_2}{e}{1}{A}{\epsilon^\prime}}
				\hypo{\pi=0 \Rightarrow \epsilon,\epsilon^\prime \equiv \Etotal}
				\infer4[\textsc{[bool-E$_1$]}]{\TypeSequent{\add{\Gamma_1}{\scale{\pi}{\Gamma_2}}}{\Eifthenelse{c}{t}{e}}{\pi}{A}{\epsilon,\epsilon^\prime}}
			\end{prooftree}
		}
	}
