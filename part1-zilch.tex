	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\begin{prooftree}
				...
				\infer2[\textsc{[$\rightarrow$-I$_2$]}]{\TypeSequent{\Gamma}{\Edo{e}}{\pi}{\Epi{\Eunderscore}{\omega}{\Eone}{\epsilon}{A}}{\epsilon^\prime}}
			\end{prooftree}
			\\\vspace*{\baselineskip}
			\begin{prooftree}
	...
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\begin{prooftree}
				...
				\infer1[\textsc{[LetIn$_0$]}]{\TypeSequent{\Gamma}{\Eletin{x}{\rho}{A}{a}{b}}{\pi}{B}{\epsilon}}
			\end{prooftree}
			\\\vspace*{\baselineskip}
			\begin{prooftree}
				...
				\infer3[\textsc{[LetIn$_1$]}]{\TypeSequent{\add{\Gamma_1}{\scale{\scale{\pi}{\rho}}{\Gamma_2}}}{\Eletin{x}{\rho}{A}{a}{b}}{\pi}{B}{\epsilon,\epsilon^\prime}}
			\end{prooftree}
			\\\vspace*{\baselineskip}
			\begin{prooftree}
				\hypo{\TypeSequent{\scale{0}{\Gamma}}{A}{0}{\Etype{\ell}}{\Etotal}}
				...
				\Eterminates{x}}
				\infer1[\textsc{[RecIn$_0$]}]{\TypeSequent{\Gamma}{\Erecin{x}{\rho}{A}{a}{b}}{\pi}{B}{\epsilon}}
			\end{prooftree}
			\\\vspace*{\baselineskip}
			\begin{prooftree}
				\hypo{\TypeSequent{\scale{0}{\Gamma_1}}{A}{0}{\Etype{\ell}}{\Etotal}}
				...
				\infer1[\textsc{[RecIn$_1$]}]{\TypeSequent{\add{\Gamma_1}{\scale{\scale{\pi}{\rho}}{\Gamma_2}}}{\Erecin{x}{\rho}{A}{a}{b}}{\pi}{B}{\epsilon,\epsilon^\prime}}
			\end{prooftree}
		}
	}
...
\begin{figure}[H]
	\framebox[\textwidth][c]{
		\parbox{\textwidth}{
			...
			\begin{prooftree}
				\hypo{\TypeSequent{\scale{0}{\Gamma}}{A}{0}{\Etype{\ell}}{\Etotal}}
				\infer1[\textsc{[Ref-F]}]{\TypeSequent{\scale{0}{\Gamma}}{\Eref{A}}{0}{\Etype{\ell}}{\Etotal}}
			\end{prooftree}
			\hspace{1.5em}
			\begin{prooftree}
				\hypo{\TypeSequent{\scale{0}{\Gamma}}{A}{0}{\Etype{\ell}}{\Etotal}}
			...
			\begin{prooftree}
				\hypo{\TypeSequent{\Gamma}{e}{\pi}{A}{\epsilon}}
				\infer1[\textsc{[Ref-I]}]{\TypeSequent{\Gamma}{\Emkref{e}}{\pi}{\Eref{A}}{\epsilon}} % maybe we want an effect for this?
			\end{prooftree}
		}
	}
